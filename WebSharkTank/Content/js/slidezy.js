...
Slidezy.prototype._initDrag = function () {
    let startX = 0;
    let currentX = 0;
    ...
    document.addEventListener("mousemove", (e) => {
        ...
        const percentMove = (move / this.container.offsetWidth) * 100;
        this.track.style.transform = `translateX(${this.offset + percentMove}%)`;
    });
    ...
    document.addEventListener("mouseup", (e) => {
        ...
        const slideBy = move > 50 ? -1 : move < -50 ? 1 : 0; // >50px thì đổi slide
        this.moveSlide(slideBy);
    });
    ...
    this.track.addEventListener("touchend", (e) => {
        ...
        isDragging = false;
        const move = currentX - startX;
        const slideBy = move > 50 ? -1 : move < -50 ? 1 : 0;
        this.moveSlide(slideBy);
    });
};
